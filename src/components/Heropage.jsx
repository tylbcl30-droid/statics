...
const HeroPage = () => {
    const [text, setText] = useState("0x000000000000");
            ...
            <div>
                ...
                >
                    <a href="" className='flex items-center gap-2'>
                        <img className='w-10 p-1 rounded-full bg-[#132B27] ' src={plasentaImage}></img>
                        <h3 className='distinct font-bold text-2xl max-sm:hidden uppercase tracking-widest'>$PLASENTA</h3>
                    </a>
  ...
  >
    ...
    <div className="md:hidden button rounded-md border border-black p-2">
      {/* Twitter Icon */}
      <svg className="w-5" fill="black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  >
    ...
    <div className="md:hidden button rounded-md border border-black p-2">
      {/* Telegram Icon */}
      <svg className="w-5" fill="black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
  ...
  >
    Buy Plasenta
            ...
            <div className='flex justify-between max-lg:flex-col lg:items-center gap-12'>
                ...
                <motion.h1 
  className="distinct text-[9rem] max-lg:text-[7rem] max-sm:text-[4.5rem] tracking-wider font-[900] leading-[1.1]"
...
>
  $Plasenta
                    ...
                    <motion.h3 className='text-sm pb-8 leading-6  '
                        ...
                        style={{ overflow: 'hidden' }}
                    >
                    Inspired by plasma, fueled by laughter, we’re here to keep the vibes purr-fect. Join the chaos, stay for the memes.
                    </motion.h3>
